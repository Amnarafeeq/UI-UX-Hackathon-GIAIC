...
const Problems = () => {
  return (
    <div className='w-[1018px] h-[188px] bg-slate-400 mx-auto my-6 flex  justify-between items-center'>
        ...
        <p className='w-[529px] h-[40px] text-sm text-textColor1'>Problems trying to resolve the conflict between the two major realms of Classical physics: Newtonian mechanics </p>
